...
local tethys = {
    ...
    seekbarHeight = 20, --default = 20
    controlsHeight = 30, --default = 64
    smallButtonSize = 42, -- controlsHeight * 2/3
    trackButtonSize = 36, -- controlsHeight / 2
    buttonTooltipSize = 20,
    windowBarHeight = 24, -- default = 44
    windowButtonSize = 24, -- default = 44
    windowTitleSize = 24,
    cacheTextSize = 20,
    timecodeSize = 17, -- default = 27
    ...
    seekbarFgColor = "674e8a", -- #d73d48  default = 483DD7
